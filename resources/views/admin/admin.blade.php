...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="http://www.isepdiamniadio.com" class="brand-link">
    
      <span class="brand-text font-weight-light">MSAS</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        {{-- <div class="image">
          <img src="\public\img\R.jpg" class="img-circle elevation-2" alt="User Image">
        </div> --}}
        <div class="info">
